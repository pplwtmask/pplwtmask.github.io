...
* [YesPlayMusic](https://github.com/qier222/YesPlayMusic/releases)，YesPlayMusic 是一个好看的第三方开源网易云音乐客户端，支持网易云账号登录、MV 播放、无任何社交功能、显示歌词、暗色模式等功能，最重要是比官方客户端好看许多，支持 Windows、macOS、Linux。
