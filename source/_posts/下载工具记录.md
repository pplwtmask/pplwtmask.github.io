...
* [File Centipede](http://filecxx.com/en_US/index.html)，一个用 C++ 和 Qt 编写的跨平台文件下载器。它界面简洁、下载速度快、支持多协议，还有浏览器插件可用来下载网页中的视频和音频

* [aria2](http://aria2.github.io/)，命令行下载工具，可以配置多线程下载，支持rpc调用，配置文件存放位置windows为例`C:\Users\user\.aria2\aria2.conf`,[配置文件地址](https://github.com/P3TERX/aria2.conf)
```
#
...
# 从会话文件中读取下载任务
#input-file=C:/Users/job/.aria2/aria2.session

# 会话文件保存路径
# Aria2 退出时或指定的时间间隔会保存`错误/未完成`的下载任务到会话文件
save-session=C:/Users/job/.aria2/aria2.session
...
dht-file-path=C:/Users/job/.aria2/dht.dat

# IPv6 DHT 文件路径，默认：$HOME/.aria2/dht6.dat
dht-file-path6=C:/Users/job/.aria2/dht6.dat
